...
# GraphRAG项目根目录路径
# 本文件位于 app/graphrag/dev/ 下，向上一级即 app/graphrag，无需硬编码机器路径。
...
# 输出目录（相对 GraphRAG 项目根目录，随项目搬移）
OUTPUT_DIR = os.path.join(PROJECT_DIR, DATA_DIR_NAME, "pdf_prompt_turn_output")
